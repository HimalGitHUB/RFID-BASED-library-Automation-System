					...
					<tr>
						<td bgcolor="#f9f9f9">
							<table width="452"  border="0" align="center" cellpadding="5"  cellspacing="0">
								...
								<tr bgcolor="#f2f2f2">
									<td align="left" class="lf">Index No</td>
									<td style="font-weight:bold">:</td>
									<td align="left"><?php echo $data['indexno'];?></td>
								</tr>
								...
								<tr bgcolor="#f2f2f2">
									...
									<td style="font-weight:bold">:</td>
									<td align="left"><?php echo $data['emailaddress'];?></td>
								</tr>
								<tr>
									<td align="left" class="lf">Batch</td>
									<td style="font-weight:bold">:</td>
									<td align="left"><?php echo $data['batch'];?></td>
								</tr>
							</table>
						</td>
					</tr>
