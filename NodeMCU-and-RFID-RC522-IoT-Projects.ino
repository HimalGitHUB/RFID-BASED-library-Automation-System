...
const char* ssid = "SLT-ADSL-C5095";
const char* password = "KDY72037";
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
...
void loop() {
  ...
  if (readsuccess) {
    ...
    http.begin("http://192.168.1.5/NodeMCU-and-RFID-RC522-IoT-Projects/getUID.php");  //Specify request destination
